package uc.ucworks.videosnap.presentation.export
...
import uc.ucworks.videosnap.data.ExportWorker
import uc.ucworks.videosnap.domain.ExportPreset
...
fun ExportDialog(
    ...
    AlertDialog(
        ...
        text = {
            Column {
                Text("Choose an export preset:")
                // TODO: Add preset selection
            }
        },
        confirmButton = {
            Button(onClick = {
                // TODO: Get selected preset
                // onExport(preset)
            }) {
                Text("Export")
            }
